      ...
      <div className={styles.content}>
        <div>
          ...
          <div className={styles.text}>
            ...
            <p className={styles.textItem}>
              Чтобы использовать все возможности сайта — необходимо пройти регистрацию. Проверка адреса электронной почты не осуществляется, вы можете ввести любой email. 
            </p>
            <p className={styles.textItem}>
        ...
        <aside>
          ...
          <div className={styles.text}>
            <p className={styles.textItem}>
              Код проекта находится тут - <a href="https://github.com/shibaevvv/foodgram" className={styles.textLink}>Github</a>
            </p>
            <p className={styles.textItem}>
              Автор проекта: <a href="https://github.com/shibaevvv" className={styles.textLink}>Владимир Шибаев</a>
            </p>
          </div>
        </aside>
      </div>
